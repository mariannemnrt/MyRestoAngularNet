...
- Create Angular project with ng: `ng new myrestoangularnet.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`myrestoangularnet.client.esproj`).
